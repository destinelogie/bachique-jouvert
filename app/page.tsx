...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#08070D] text-white min-h-screen font-sans antialiased flex flex-col justify-between selection:bg-[#FF2A85]">
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="fixed top-[75px] left-0 w-full z-[998] bg-[#08070D] border-b border-white/10 px-4 pt-2 pb-6 space-y-3 md:hidden">
      ...
      <main className="flex-grow pt-32">
        <section id="home" className="relative min-h-[80vh] flex items-center justify-center px-4 overflow-hidden text-center scroll-mt-28">
      ...
      <footer className="border-t border-white/10 bg-[#08070D]/80 backdrop-blur-md pt-12 pb-8 px-4 text-center">
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-6 my-2">
            ...
            {/* Facebook */}
            <a 
              href="https://www.facebook.com/share/19Kf1bCKPW/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="p-3 rounded-full bg-white/5 border border-white/10 hover:border-[#4CC9F0] hover:bg-[#4CC9F0]/10 text-white hover:text-[#4CC9F0] transition-all duration-300"
              aria-label="Facebook"
            >
